app.controller('TestController', ['$scope', 'Basic_InformationService', 'DepartmentService', 'ClassService', 'filterFilter', '$routeParams', '$location', function ($scope, Basic_InformationService, DepartmentService, ClassService, filterFilter, $routeParams, $location) {

    $scope.test = "Hi Testsdsd";
...
app.controller('TestAddEditStudentController', ['$scope', 'Basic_InformationService', 'DepartmentService', 'ClassService', '$routeParams', '$location', function ($scope, Basic_InformationService, DepartmentService, ClassService, $routeParams, $location) {
    console.log("Hello");
    $scope.profileid = $routeParams.Id;
